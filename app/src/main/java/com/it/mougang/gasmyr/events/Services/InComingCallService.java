...
public class InComingCallService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        if (intent != null) {
            ...
            callMakerNumber = bundle.getString(GlobalConstants.EVENT_INCOMING_CALL_MAKER_NUMBER);
            callDate = bundle.getString(GlobalConstants.EVENT_INCOMING_CALL_DATE);
            callType = CallType.valueOf(bundle.getString(GlobalConstants.EVENT_INCOMING_CALL_TYPE));
